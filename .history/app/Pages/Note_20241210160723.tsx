...
const Note: React.FC<NoteProp> =()=>{
    ...
    const noteInner = async () => {
      ...
      const toggleNoteInputCard = () => {
        setshowNoteInputCard(prev => !prev);
    };
    ...
    return(
        <div className="mt-20 ml-10 mr-10">
            <div className="mb-10 ">
                ...
                onClick= {()=> toggleNoteInputCard()}
                >新增記事</button>
                {toggleNoteInputCard && <NoteInputCard onSubmit={function (data: NoteInputCardProps): void {
