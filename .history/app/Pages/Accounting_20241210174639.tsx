            ...
            <div key={index} className="flex justify-center">
                {item.accounting && (
                    <div className="grid grid-cols-3 gap-4 font-black">
                        <Checkbox key={item.accountST}/>
                        <div className="flex justify-center" key={item.accountingId}>{item.accountingId}</div>
                        <div className="flex justify-center" key={item.accountInner}>{item.accountingId.accountAmount}</div>
                    </div>
                )} 
          </div>
        ))
