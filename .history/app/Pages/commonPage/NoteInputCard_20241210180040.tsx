import {
  ...
  const NoteInputCard = ({ onSubmit }: { onSubmit: (data: NoteInputCardProps) => void }) => {
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-100 z-1">
        <Card className="items-center w-[30rem] h-[30rem] flex flex-col">
          ...
          <CardFooter className="flex justify-center bg-black w-full">
            <Button className="text-white" onClick={addNoteData}>Submit</Button>
          </CardFooter>
        </Card>
      </div>
    );
