...
const NoteInputCard = ({ onSubmit, onClose }: NoteInputCardProps) => {
    ...
    const addNoteData = async () => {
        try {
            ...
            // Use Navigate to redirect after closing the card model
            Navigate('/path-to-redirect'); // Replace '/path-to-redirect' with your actual path
    ...
    const closeCardModel = () => {
        ...
        onClose(); 
        // Use Navigate to redirect after closing the card model
        Navigate('/Note.tsx'); // Replace '/path-to-redirect' with your actual path
    };
