  ...
  return (
    <div className="w-screen justify-center">
        <div className="flex justify-center">
            <div className="inline-grid grid-cols-3 gap-10 justify-center">
        ...
        {accountData.length > 0 ?
            ...
            <div key={index}>
                {item.accountingId && (
                    ...
                    <div className="flex justify-center font-medium" key={item.accountingId.id}>{item.accountingId.accountInner}</div>
                    <div className="flex justify-center font-medium" key={item.accountingId.id}>{item.accountingId.accountAmount}</div>
                    </div>
                )} 
          </div>
        ))
