        ...
        {accountData.length > 0 ?
            ...
            <div key={index}>
                {item.accountingId && (
                    ...
                    <div className="flex justify-center font-black" key={item.accountingId.id}>{item.accountingId.accountInner}</div>
                    <div className="flex justify-center font-black" key={item.accountingId.id}>{item.accountingId.accountAmount}</div>
                    </div>
                )} 
          </div>
        ))
